(function(){
      ...
      <div class="container">
        ...
        <div class="testimonials-carousel" data-testimonials-carousel aria-label="Carrusel de testimonios del desafío">
          ...
          <div class="testimonials-track" data-testimonials-track>
            ...
            <figure class="testimonial-card testimonial-slide"><div class="testimonial-image-wrap"><img src="/embocadura-organizada/Testimonio%201.jpeg" alt="Testimonio de una alumna que agradece el material y cuenta sus descubrimientos" loading="lazy" decoding="async"></div><figcaption><strong>Descubrimientos desde el comienzo</strong><span>“Gracias por este tesoro de material.”</span></figcaption></figure>
            <figure class="testimonial-card testimonial-slide testimonial-highlight"><div class="testimonial-image-wrap"><img src="/embocadura-organizada/Testimonio%204.jpeg" alt="Testimonio de alumno en el día 8: la flauta le suena llena y enfocada en todos los registros" loading="lazy" decoding="async"></div><figcaption><strong>Día 8: sonido lleno y enfocado</strong><span>“Ya me está sonando la flauta como nunca en todos los registros.”</span></figcaption></figure>
          </div>
  ...
  function setupTestimonialsCarousel(section){
    ...
    function start(){if(reduced||timer||maxIndex()===0)return;timer=window.setInterval(()=>go(1),2600)}
    ...
    if('IntersectionObserver'in window){new IntersectionObserver(entries=>{entries.forEach(entry=>{if(entry.isIntersecting){section.classList.add('is-carousel-active');start()}else stop()})},{threshold:.18}).observe(section)}else{section.classList.add('is-carousel-active');start()}
    requestAnimationFrame(()=>{render();setTimeout(render,450)});
  }
  ...
  function injectCss(){
    ...
    style.textContent=`
      ...
      .testimonials-carousel{position:relative;margin-top:38px;opacity:.78;transform:translateY(16px);transition:opacity .55s ease,transform .55s ease}.testimonials-section.is-carousel-active .testimonials-carousel{opacity:1;transform:translateY(0)}.testimonials-carousel:before,.testimonials-carousel:after{content:'';position:absolute;top:0;bottom:0;width:76px;z-index:2;pointer-events:none}.testimonials-carousel:before{left:0;background:linear-gradient(90deg,rgba(255,250,243,.92),transparent)}.testimonials-carousel:after{right:0;background:linear-gradient(270deg,rgba(255,250,243,.92),transparent)}.testimonials-track{display:flex;gap:18px;will-change:transform;transition:transform .58s cubic-bezier(.2,.82,.2,1)}
      .testimonial-card{flex:0 0 calc((100% - 36px)/3);margin:0;padding:10px;border-radius:24px;background:rgba(255,255,255,.92);border:1px solid rgba(174,230,223,.52);box-shadow:0 18px 46px rgba(33,29,29,.075);transition:.22s ease}.testimonial-card:hover{transform:translateY(-4px);box-shadow:0 24px 58px rgba(33,29,29,.12)}.testimonial-highlight{border-color:rgba(196,32,48,.28);box-shadow:0 18px 50px rgba(196,32,48,.10)}.testimonial-image-wrap{overflow:hidden;border-radius:17px;background:#151515;aspect-ratio:4/5;display:flex;align-items:center;justify-content:center}.testimonial-image-wrap img{width:100%;height:100%;object-fit:contain}.testimonial-card figcaption{display:grid;gap:6px;padding:14px 8px 8px}.testimonial-card figcaption strong{font-family:var(--serif);font-size:clamp(1.16rem,1.65vw,1.55rem);line-height:1}.testimonial-card figcaption span{color:rgba(111,102,102,.88);font-size:.82rem;font-weight:750;line-height:1.45}.testimonial-arrow{position:absolute;top:42%;z-index:3;width:42px;height:42px;border:1px solid rgba(174,230,223,.76);border-radius:50%;background:rgba(255,255,255,.92);box-shadow:0 12px 28px rgba(33,29,29,.10);color:var(--dark);font-size:2rem;line-height:1;display:grid;place-items:center;cursor:pointer}.testimonial-prev{left:8px}.testimonial-next{right:8px}.testimonial-arrow:hover{background:var(--mint-soft)}.testimonials-note{margin:22px 0 0;text-align:center;color:rgba(111,102,102,.68);font-size:.78rem;font-weight:750}
      @media(max-width:1039px){.testimonial-card{flex-basis:calc((100% - 18px)/2)}}@media(max-width:900px){.nav-links>a:not(.btn):not(.language-switch a){display:none!important}.testimonials-heading{display:grid}.testimonials-badge{width:max-content;max-width:100%}.testimonials-carousel{margin-top:28px}.testimonials-carousel:before,.testimonials-carousel:after{width:34px}}@media(max-width:719px){.testimonial-card{flex-basis:100%;border-radius:22px}.testimonial-image-wrap{border-radius:15px}.testimonial-arrow{width:38px;height:38px;font-size:1.8rem}.testimonial-card figcaption{padding:13px 6px 7px}.testimonial-card figcaption span{font-size:.8rem}}@media(prefers-reduced-motion:reduce){.testimonials-track,.testimonials-carousel{transition:none!important}}
    `;
